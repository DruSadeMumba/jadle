...
public class SqlRestaurantDao implements RestaurantDao{

    private final Sql2o sql2o;
    public SqlRestaurantDao(Sql2o sql2o) { this.sql2o = sql2o; }
    ...
    @Override
    public Collection<Object> Restaurant(int restaurantId) {
        return null;
    }
}
